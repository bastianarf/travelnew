...
$sql_artikel = "SELECT * FROM artikel WHERE kategori NOT IN ('penulis', 'slide') AND judul='Hubungi Kami' ORDER BY id DESC";
  ...
  <body>
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div style="font-size:20px;text-align:justify;"><?php echo $data_post['konten']; ?></div>
		</div>
	</div>
	</div>
  ...
  ?>
   ...
   <?php endwhile; ?>
	 ...
	 <?php endif; ?>
      ...
      <!-- FOOTER -->
      <footer>
        <p class="pull-right"><a href="hubungikami.php">Back to top</a></p>
