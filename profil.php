...
$sql_artikel = "SELECT * FROM artikel WHERE kategori NOT IN ('penulis', 'slide') AND judul='Profil' ORDER BY id DESC";
  ...
  ?>
   ...
   <?php endwhile; ?>
	 ...
	 <?php endif; ?>
      ...
      <!-- FOOTER -->
      <footer>
        <p class="pull-right"><a href="profil.php">Back to top</a></p>
